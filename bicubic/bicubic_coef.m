function A = bicubic_coef(f, Ix, Iy, Ixy, x1, y1, x2, y2)
    ...
    second = [f(x1, y1), f(x1, y2), Iy(x1, y1), Iy(x1, y2); f(x2, y1), f(x2, y2), Iy(x2, y1), Iy(x2, y2); Ix(x1, y1), Ix(x1, y2), Ixy(x1, y1), Ixy(x1, y2); Ix(x2, y1), Ix(x2, y2), Ixy(x2, y1), Ixy(x2, y2)];
