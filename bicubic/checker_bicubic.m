function [score] = checker_bicubic()
    ...
    score = bicubic_points * (bicubic_diff / bicubic_diff_max / 5 + bicubic_coef / bicubic_coef_max / 5 + bicubic_resize / bicubic_resize_max / 5 + bicubic_resize_RGB / bicubic_resize_RGB_max / 5);
